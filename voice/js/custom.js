        ...
        function sticky_sidebar(fixed) {
            ...
            if ($(window).width() >= 1024) {
                ...
                if ($('.vce-sticky').length > 0) {
                    ...
                    //var content_height =  $('.site-content').height() - 15; 
                    ...
                    if (content_height > sidebar_height) {
                        ...
                        if (fixed && $(".vce-sticky").last().css('position') == 'absolute') {
                            $(".vce-sticky").last().css('position', 'fixed').css('top', vce_top_position);
                        }

                    } else {
                        $('.sidebar').css('min-height', sidebar_height + 50);
                    }
