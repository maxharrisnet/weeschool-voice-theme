...
?>
	   ...
	   <div class="vce-opt-item">
	   		...
	   		<label><input type="checkbox" name="vce[fa_cat_child]" value="1" class="vce-count-me" <?php checked( $vce_meta['fa_cat_child'], 1  );?>/><strong><?php _e( 'Apply child categories', THEME_SLUG ); ?></strong></label><br/>
		    		<small class="howto"><?php _e( 'If parent category is selected, posts from child categories will be selected automatically', THEME_SLUG ); ?></small>
	   		<br/>
	   		<?php endif; ?>
	   		<label><input type="radio" name="vce[fa_cat_inc_exc]" value="in" <?php checked( $vce_meta['fa_cat_inc_exc'], 'in' ); ?> class="vce-count-me" /><?php esc_html_e('Include', THEME_SLUG) ?></label><br/>
	   		<label><input type="radio" name="vce[fa_cat_inc_exc]" value="not_in" <?php checked( $vce_meta['fa_cat_inc_exc'], 'not_in' ); ?> class="vce-count-me" /><?php esc_html_e('Exclude', THEME_SLUG) ?></label><br/>
	   		<small class="howto"><?php esc_html_e( 'Wheter to include or exclude posts from selected categories', THEME_SLUG ); ?></small>
	   		<br/>
			...
			<br>
			<label><input type="radio" name="vce[fa_tag_inc_exc]" value="in" <?php checked( $vce_meta['fa_tag_inc_exc'], 'in' ); ?> class="vce-count-me" /><?php esc_html_e('Include', THEME_SLUG) ?></label><br/>
	   		<label><input type="radio" name="vce[fa_tag_inc_exc]" value="not_in" <?php checked( $vce_meta['fa_tag_inc_exc'], 'not_in' ); ?> class="vce-count-me" /><?php esc_html_e('Exclude', THEME_SLUG) ?></label><br/>
	   		<small class="howto"><?php esc_html_e( 'Wheter to include or exclude posts from selected tags', THEME_SLUG ); ?></small>
	   ...
	   <?php endforeach; ?>
		...
		<label><input type="radio" name="vce[fa_sort]" value="DESC" <?php checked( $vce_meta['fa_sort'], 'DESC' ); ?> class="vce-count-me" /><?php esc_html_e('Descending', THEME_SLUG) ?></label><br/>
		<label><input type="radio" name="vce[fa_sort]" value="ASC" <?php checked( $vce_meta['fa_sort'], 'ASC' ); ?> class="vce-count-me" /><?php esc_html_e('Ascending', THEME_SLUG) ?></label><br/>
	   </div>
	...
	function vce_save_page_metaboxes( $post_id, $post ) {
		...
		if ( $post->post_type == 'page' && isset( $_POST['vce'] ) ) {
			...
			if ( $vce_meta['fa_layout'] ) {
				...
				$vce_meta['fa_cat_inc_exc'] = isset( $_POST['vce']['fa_cat_inc_exc'] ) ? $_POST['vce']['fa_cat_inc_exc'] : 'in';
				$vce_meta['fa_tag_inc_exc'] = isset( $_POST['vce']['fa_tag_inc_exc'] ) ? $_POST['vce']['fa_tag_inc_exc'] : 'in';
